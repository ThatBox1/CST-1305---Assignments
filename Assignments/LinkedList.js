...
class LinkedList {
    ...
    append(data){
        ...
        if(!this.head){
            this.head = newNode; //Set node as head if list is empty
        }
        else{
            let current = this.head;
            // Iterate to the last node, setting the next to the current each time
            while(current.next){
  ...
  // H,         P       nN       C
    ...
    removeLast(){
        ...
        let current = this.head
        // Return the removed node if there is only 1 in the list
        if(!current.next){
            let removedNode = this.head;
            this.head = null;
            this.size--;
        ...
        // Set the last node to null - deleting it
        previous.next = null;
...
linkedList.insertAt(15, 2); // 30 -> 20 -> 15 -> 10 -> null
linkedList.updateAt(25, 3); // 30 -> 20 -> 15 -> 25 -> null
linkedList.append(50);      // 30 -> 20 -> 15 -> 25 -> 50 -> null 
linkedList.removeLast();    // 30 -> 20 -> 15 -> 25 -> null
linkedList.printList();     // 30 -> 20 -> 15 -> 25 -> null
